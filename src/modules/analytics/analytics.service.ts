...
export class AnalyticsService {
  ...
  private readonly anomaliesOverTime: AnomalyTimePoint[] = [
  ...
  private readonly anomalyByType: AnomalyTypeCount[] = [
  ...
  private readonly severityDistribution: SeveritySlice[] = [
  ...
  private readonly wordFrequencies: WordFrequency[] = [
  ...
  private readonly peopleByBusiness: BusinessPeopleCount[] = [
  ...
  getAnomalyTrend(): AnomalyTimePoint[] {
    return this.anomaliesOverTime;
  }

  getAnomalyType(): AnomalyTypeCount[] {
    return this.anomalyByType;
  }
